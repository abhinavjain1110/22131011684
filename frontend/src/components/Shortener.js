...
const Shortener = () => {
    ...
    return (
        <Paper sx={{ p: 2 }}>
            ...
            <Button onClick={addField} sx={{color:"black"}} disabled={urls.length >= 5}>Add More</Button>
            <Button variant="contained" sx={{backgroundColor:"black"}} onClick={handleSubmit}>Shorten URLs</Button>
